...
public class AppProvider extends ContentProvider {
    ...
    static final String CONTENT_AUTHORITY = "com.example.huntergreer.tasktimer.provider";
...
//                break;
        ...
        // something was inserted, updating
...
//                break;
        ...
        //if something was deleted, notify
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues values, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (match) {
            ...
            case TASKS_ID:
                ...
                Log.d(TAG, "update: selection criteria = " + selectionCriteria);
